...
<template>
  <div>
    ...
    <el-table size="small" :data="listData" highlight-current-row v-loading="loading" border element-loading-text="拼命加载中" style="width: 100%;">
      ...
      <el-table-column sortable prop="machineNo" label="内容ID" width="200">
      </el-table-column>
      <el-table-column sortable prop="payType" label="网址" width="200">
      </el-table-column>
      <el-table-column sortable prop="configName" label="标题" width="200">
      </el-table-column>
      <el-table-column sortable prop="payOpen" label="图片地址" width="200">
<!--
    ...
    <el-dialog :title="title" :visible.sync="editFormVisible" width="30%" @click="closeDialog">
      <el-form label-width="120px" :model="editForm" :rules="rules" ref="editForm">
        <el-form-item label="内容ID" prop="id">
          <el-input size="small" v-model="editForm.machineNo" auto-complete="off" ></el-input>
        </el-form-item>
       ...
       <!--   <el-select size="small" v-model="editForm.payType" placeholder="请选择" class="userRole">
          ...
          <el-input size="small" v-model="editForm.configId" auto-complete="off" placeholder="请输入网址"></el-input>
        </el-form-item>
        <el-form-item label="标题" prop="title">
          <el-input size="small" v-model="editForm.configId" auto-complete="off" placeholder="请输入标题"></el-input>
        </el-form-item>
        <el-form-item label="图片地址" prop="imgAddress">
          <el-input size="small" v-model="editForm.configName" auto-complete="off" placeholder="请输入图片地址"></el-input>
        </el-form-item>
