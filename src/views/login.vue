  ...
  <div class="login-wrap">
    <el-form label-position="left" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="0px" class="demo-ruleForm login-container">
      ...
      <el-form-item prop="loginPassword">
        <el-input type="password" v-model="ruleForm.loginPassword" auto-complete="off" placeholder="密码"></el-input>
      </el-form-item>
<!--      <el-row>
        <el-col :span="12">
  ...
  methods: {
    ...
    getuserpwd() {
      if (getCookie('user') != '' && getCookie('pwd') != '') {
        ...
        this.ruleForm.loginPassword = getCookie('pwd')
...
/*      if( this.ruleForm.username!="admin" || this.ruleForm.password!='123456'){
      ...
      /*    setTimeout(() => {
        ...
        /*      if (this.rememberpwd) {
                //保存帐号到cookie，有效期7天
                setCookie('user', this.ruleForm.loginName, 7)
                //保存密码到cookie，有效期7天
                setCookie('pwd', this.ruleForm.loginPassword, 7)
              } else {
                delCookie('user')
                delCookie('pwd')
              }*/
